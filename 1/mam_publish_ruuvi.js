...
Adjusted by Michael Rissi to run on tangle, not testnet
Reads from the ruuvitag, and sends the data to the tangle.
...
// global variable ruuvi_data. This can be solved in a more js way...
let ruuvi_data = {};
ruuvi.on('found', tag => {
